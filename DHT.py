#DHT = Detect Humidity Tempreture
...
DHT_topic = 'pr/home/315877639/sts'
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QIcon('Images/dht_icon.png'))         
    ...
    #update sensor temperature only if connected
    def update_data(self):
        if (CONNECTED):
            print('Next update')
            temp=22+random.randrange(1,10)/10
            hum=30+random.randrange(1,25)/10
            ...
            InsertToDatabaseSensor(database,tablename_1,date,temp,hum)
