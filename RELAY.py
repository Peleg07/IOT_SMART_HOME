...
relay_topic = "IOT/UnderFloorHeating"
global ON
ON = False
...
class Mqtt_client():
    ...
    def on_message(self, client, userdata, msg):
        ...
        recive_message = "message from: {}, message: {}".format(topic,m_decode)
        InsertToDatabase(database,tablename_3,date,recive_message)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set up main window
        self.setGeometry(30, 300, 450, 150)
        self.setWindowTitle('RELAY')  
        self.setWindowIcon(QIcon('Images/relay_icon.png'))      
