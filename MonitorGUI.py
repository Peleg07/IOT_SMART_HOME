...
class Mqtt_client():
    ...
    def on_connect(self, client, userdata, flags, rc):
        if rc==0:
            print("System Connection: OK")
            self.on_connected_to_form();            
        else:
            print("System Connection: Error, Returned code=",rc)
...
class SubscribeDock(QDockWidget):
    ...
    def update_mess_win(self,text):
        self.eRecMess.append("Update message ->" + text)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Underfloor Heating System') 
        self.setWindowIcon(QIcon('Images/fire_icon.png'))      
