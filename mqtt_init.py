...
ports=['80','1883']
usernames = ['#','Admin'] # should be modified for HIT
passwords = ['#','FloorAdmin'] # should be modified for HIT
...
mzs=['','']
sub_topics =[mzs[nb]+'#','IOT/UnderFloorHeating']
pub_topics = [mzs[nb]+'#','IOT/UnderFloorHeating']
